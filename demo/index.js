...
(function () {
  ...
  var sampleFolder = process.env.STATIC_FILES_SUBFOLDER
      ? process.env.STATIC_FILES_SUBFOLDER + "/"
      : "",
    samples = {
      "Clarinet Breath": "Clarinet - 2 - All Tied Up with extra tie.musicxml",
  ...
  function init() {
    ...
    showDebugControls =
      paramDebugControls === "1" ||
      (devDemoRunning && paramDebugControls !== "0");
